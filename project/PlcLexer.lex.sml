...
{fin = [(N 19),(N 64)], trans = 21},
{fin = [(N 60)], trans = 0},
{fin = [(N 44),(N 64)], trans = 0},
{fin = [(N 17),(N 64)], trans = 0},
{fin = [(N 21),(N 64)], trans = 0},
...
| 21 => (TIMES(yypos, yypos))
| 23 => (DIV(yypos, yypos))
| 25 => (EQUAL(yypos, yypos))
| 28 => (NEQUAL(yypos, yypos))
| 30 => (LT(yypos, yypos))
| 33 => (LTE(yypos,yypos))
| 36 => (CONS(yypos,yypos))
| 38 => (SEMICOL(yypos, yypos))
| 4 => (lex())
| 40 => (LBRACK(yypos, yypos))
| 42 => (RBRACK(yypos, yypos))
| 44 => (COMMA(yypos, yypos))
| 46 => (LBRACE(yypos, yypos))
| 48 => (RBRACE(yypos, yypos))
| 50 => (LPAREN(yypos, yypos))
| 52 => (RPAREN(yypos, yypos))
| 54 => (VBAR(yypos, yypos))
| 57 => (EQARROW(yypos, yypos))
| 60 => (ARROW(yypos, yypos))
| 62 => (COLON(yypos, yypos))
